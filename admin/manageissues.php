...
<html>
<head>
<title>Upravljaj problemima</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Naslovna strana</a><i class="fa fa-angle-right"></i>Upravljaj problemima</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Upravljanje problemima korisnika</h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th>#</th>
